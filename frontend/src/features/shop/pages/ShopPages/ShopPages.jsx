  ...
  return (
    <>
      <div className=" py-10 px-5 md:px-12 lg:px-15 my-10">
        <h2 className="text-3xl font-bold text-gray-800 text-center mb-10">{t('shops.title')}</h2>
        <div className="flex flex-wrap justify-center gap-6">
          {stores.map((shop, index) => (
            ...
            >
              ...
              {shop.isNew && (
                <span className="inline-block mt-2 bg-blue-500 text-white text-xs px-2 py-1 rounded">{t('shop.newBadge')}</span>
              )}
            </a>
          ))}
        </div>
