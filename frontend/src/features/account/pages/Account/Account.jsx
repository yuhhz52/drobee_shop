...
import { setLoading as setGlobalLoading } from '@app/store/slices/common.jsx'
import { fetchUserDetails } from '@services/user.service'
import { loadUserInfo, selectIsUserAdmin, selectUserInfo } from '@app/store/slices/user.jsx';
import { isTokenValid, getAccessToken } from '@shared/utils/jwt-helper';
        ...
        return (
            <div className='horizon-account-page'>
                <div className="horizon-account-auth-gate">
                    <h2>{t('auth.authGate.title')}</h2>
                    <p>{t('auth.authGate.description')}</p>
