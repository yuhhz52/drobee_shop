...
export const { loadUserInfo, saveAddress, removeAddress, updateAvatar, loadOrders, cancelOrder } = userSlice?.actions;
...
export const selectIsUserAdmin = (state) =>
  state?.userState?.userInfo?.authorityList?.includes("ROLE_ADMIN");
